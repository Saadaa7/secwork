...
class _PostedjobState extends State<Postedjob> {
  ...
  void getMyData() async {
    print('home screen:'+FirebaseAuth.instance.currentUser!.uid);
    final DocumentSnapshot userDoc = await FirebaseFirestore.instance
      ...
      // print();
      print(userDoc.get('address'));

    // if (userDoc.exists) {
    //   // Get the document data as a Map
    //   final data = userDoc.data();
    //
    //   // Check if 'name', 'user_image', and 'address' fields exist in the document
    //   if (data != null && data.containsKey('name') && data.containsKey('user_image') && data.containsKey('address')) {
    //     setState(() {
    //       name = data() as String;
    ...
    //     print('One or more fields are missing in the document.');
    //   }
    // } else {
          ...
          child: Row(
            children: [
              ...
              Text(
                ...
                style: txt.body2Dark.copyWith(color: Colors.grey,fontFamily: 'Rubik', fontSize: 16),
