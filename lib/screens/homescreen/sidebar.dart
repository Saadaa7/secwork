          ...
          children:  [
            ...
            Padding(
              ...
              child: SingleChildScrollView(
                child: Container(
                  child: Text(
                      '''Welcome to our Cyber Security freelancing app, the perfect platform for freelancers and clients to connect and work together. Our app is designed to make the freelancing experience easy, efficient and secure.
            ...
            children: [
              ListTile(
                ...
                title: const Text("About Us",
                    style:
                        TextStyle(fontSize: 18, fontFamily: 'Rubik',fontWeight: FontWeight.bold)),
              ),
              ListTile(
                onTap: () {
